...
public class CreateKeyPairFeature extends AbstractCreateFeature {
	  ...
	  public Object[] create( final ICreateContext context ) {    
	    ...
	    String deploymentArtifactName = "K" + (tempDeploymentArtifact.getName()).replaceAll("[^a-zA-Z0-9\\s]", "");
	    ...
	    String deploymentArtifactRef = "K" + (deploymentArtifact.getArtifactRef().toString()).replaceAll("[^a-zA-Z0-9\\s]", "");
